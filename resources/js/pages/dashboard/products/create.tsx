...
import { ImagePlus, ArrowLeft, Save, X } from "lucide-react";
import { store } from "@/routes/dashboard/products";
import { index } from "@/routes/dashboard/products";
...
export default function ProductCreate({ categories, ingredients }: ProductCreateProps) {
                    ...
                    >
                        {imagePreview ? (
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <span className="nunito font-semibold text-gray-500 text-[24px]">Click para subir imagen</span>

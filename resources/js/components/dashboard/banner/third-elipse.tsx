export default function ThirdElipseBanner({ className }: { className?: string }) {
    return (
        <svg className={className} width="175" height="102" viewBox="0 0 175 102" fill="none" xmlns="http://www.w3.org/2000/svg">

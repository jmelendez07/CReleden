export default function SecondElipseBanner({ className }: { className?: string }) {
    return (
        <svg className={className} width="175" height="144" viewBox="0 0 175 144" fill="none" xmlns="http://www.w3.org/2000/svg">

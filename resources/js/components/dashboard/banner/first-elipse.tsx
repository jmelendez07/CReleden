export default function FirstElipseBanner({ className }: { className?: string }) {
    return (
        <svg className={className} width="285" height="114" viewBox="0 0 285 114" fill="none" xmlns="http://www.w3.org/2000/svg">
